...
class Train:
    def __init__(self):
        ...
        self.early_stopping = EarlyStopping.EarlyStopping(patience=self.settings.patience,
    ...
    def __initialize(self):
        ...
        self.bert_text_model = BERTClassifier.BERTClassifier()
    ...
    def __create_data_loaders(self, sentence1, sentence2, targets, batch_size, num_workers):
        dataset = BERTDataset.BERTDataset(sentence_1=sentence1,
